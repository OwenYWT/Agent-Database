...
class MemGPTConfig:
    ...
    #only read from config, not overwiten
    #parameter llm_config is overwriten
    @classmethod
    def load(cls, llm_config: Optional[LLMConfig] = None, embedding_config: Optional[EmbeddingConfig] = None) -> "MemGPTConfig":
        ...
        if os.getenv("MEMGPT_CONFIG_PATH"):
            ...
            config_path = MemGPTConfig.config_path  #/home/yzhao862/.memgpt/config
    ...
    def create_config_dir():
        ...
        #create these sub folders in ~/.memgpt
        folders = [
            "agents",
            "archival",
            "functions",
